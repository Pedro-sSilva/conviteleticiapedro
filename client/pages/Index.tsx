...
const WeddingHomepage = () => {
  ...
  const galleryImages = [
    "../assets/img/IMG_46.jpg", "../assets/img/IMG_1048.jpg", "../assets/img/IMG_71.jpg", 
    "../assets/img/IMG_1132.jpg", "../assets/img/IMG_87.jpg", "../assets/img/IMG_1168.jpg", 
    "../assets/img/IMG_146.jpg", "../assets/img/IMG_1193.jpg", "../assets/img/IMG_184.jpg", 
    "../assets/img/IMG_1244.jpg", "../assets/img/IMG_198.jpg", "../assets/img/IMG_1251.jpg", 
    "../assets/img/IMG_286.jpg"];
  ...
  return (
    <div className="min-h-screen bg-cream overflow-x-hidden">
      ...
      <section
        ...
        style={{
          backgroundImage: "url('../assets/img/IMG_1163.jpg')",
          paddingLeft: '200px',
        }}
      >
        <style dangerouslySetInnerHTML={{
          __html: `
            @media (max-width: 640px) {
              .mobile-bg {
                background-image: url("../assets/img/IMG_1173.jpg") !important;
              }
                
            @media (max-width: 1215px) {
              .mobile-bg {
                background-image: url("../assets/img/IMG_1163T.jpg");
          ...
          <div className="text-center mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="relative w-full rounded-2xl aspect-[1/1] overflow-hidden mb-6 md:mb-8 lg:mb-10">
                <img className="absolute inset-0 w-full h-full object-cover" src="../assets/img/IMG_168.jpg" alt="Convite" />
              </div>
        ...
        <div className="max-w-6xl mx-auto px-6 w-full">
          <div className="text-center mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center justify-items-center">
              <div className="relative w-full rounded-2xl aspect-[1/1] overflow-hidden mb-6 md:mb-8 lg:mb-10">
                <img className="absolute inset-0 w-full h-full object-cover" src="../assets/img/IMG_138.jpg" alt="Convite" />
              </div>
